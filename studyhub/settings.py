...
ALLOWED_HOSTS = ['studyhub-2.onrender.com', 'localhost', '127.0.0.1']
...
# ✅ Superuser/Admins ke email
ADMINS = [('Admin', 'admin_email@gmail.com')]

# ✅ Email Settings (Sensitive info removed)
...
# For local development (testing emails in console)
